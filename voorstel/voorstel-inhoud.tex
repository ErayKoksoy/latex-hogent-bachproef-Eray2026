...
Deze problematiek is bijzonder relevant wanneer men rekening houdt met het feit dat ongeveer één op de vijf Belgen leeft met een handicap uit een onderzoek van de \textcite{EuropeseUnie2025}. Daarnaast blijkt dat 16,3\% van de leeftijdsgroep van 16 tot 24 jaar, die een aanzienlijk deel van de studentenpopulatie vertegenwoordigt, leeft met een beperking \autocite{EuropeseUnie2025}. Dit benadrukt dat digitale toegankelijkheid geen randfenomeen is, maar een essentiële voorwaarde om een substantiële gebruikersgroep volwaardig te laten participeren aan het hoger onderwijs.

Binnen het opleidingsonderdeel Real-life Integrated Software Engineering (RISE) werd samen met een team een proof-of-concept (POC) ontwikkeld voor een toekomstige HOGENT-campusapplicatie. Deze POC werd na evaluatie door docenten en de IT-dienst van HOGENT geselecteerd als de best uitgewerkte en meest geschikte basis voor verder onderzoek. Tijdens het ontwikkelproces werd echter duidelijk dat digitale toegankelijkheid niet structureel werd meegenomen. Deze observatie sluit aan bij bevindingen uit recent onderzoek naar toegankelijkheid in softwareontwikkeling \autocite{Teran2021}, waaruit blijkt dat toegankelijkheid zelden wordt opgenomen als een vereiste in de vroege stadia van het ontwikkelproces. Hoewel ontwikkelaars het belang van toegankelijkheid erkennen, wordt dit onderwerp vaak pas geëvalueerd na de ontwikkeling, waardoor aanpassingen kostbaar en moeilijk zijn. Hierdoor vormt deze POC een concrete en realistische casus om te onderzoeken hoe toegankelijkheid technisch geïntegreerd kan worden in mobiele applicaties binnen een onderwijscontext.

De huidige versie van de applicatie werd tijdens de ontwikkeling niet systematisch geëvalueerd aan de hand van de WCAG-richtlijnen, waardoor onduidelijk is in welke mate studenten met beperkingen drempels ervaren tijdens het gebruik ervan. Dit gebrek aan inzicht houdt bovendien het risico in dat de applicatie niet voldoet aan de reeds geldende Europese toegankelijkheidsregelgeving. De Europese Richtlijn (EU) 2016/2102 verplicht publieke instellingen, waaronder onderwijsinstellingen, om hun websites en mobiele applicaties conform te maken aan de WCAG-richtlijnen. Ook de Belgische overheid benadrukt dat alle publieke digitale platformen aan deze normen moeten voldoen \autocite{BelgianWebAccessibility2025}. Het niet naleven van deze regelgeving kan leiden tot structurele uitsluiting van studenten met beperkingen en tot het niet voldoen aan wettelijke verplichtingen.

Dit leidt tot de centrale onderzoeksvraag van deze bachelorproef: Hoe kan de HOGENT-campusapp inclusiever worden ontworpen voor studenten met een beperking, rekening houdend met hun specifieke noden op het vlak van digitale toegankelijkheid? Deze hoofdvraag kan opgesplitst worden in volgende deelvragen:
...
Het eindresultaat van dit onderzoek is een toegankelijkere en technisch verbeterde versie van de bestaande POC, samen met een rapport waarin de technische beslissingen en ontwikkelkeuzes worden toegelicht. Daarmee levert deze bachelorproef een praktische en relevante bijdrage aan de ontwikkeling van duurzame, inclusieve en performante mobiele applicaties binnen het hoger onderwijs.
...
\subsection{Testtools voor digitale toegankelijkheid}

Effectieve testing van digitale toegankelijkheid is cruciaal om mobiele en webapplicaties bruikbaar te maken voor alle gebruikers, inclusief personen met fysieke, sensorische of cognitieve beperkingen. \textcite{ZhyrovaEtAl2022} benadrukken dat hoewel internationale richtlijnen zoals WCAG 2.1 een duidelijk kader bieden, de standaardisering van toegankelijkheidstesten nog vaak ontbreekt. 

\subsubsection{Doel en aanpak van toegankelijkheidstesten}
Toegankelijkheidstesten hebben tot doel mogelijke barrières voor gebruikers met beperkingen te identificeren. De aanpak begint met het definiëren van de doelgroep, inclusief specifieke beperkingen en het analyseren van hun interactie met de applicatie. Voor cognitieve beperkingen zoals dyslexie, dementie, epilepsie of aandachtstekorten, dienen specifieke ontwerp- en testcriteria gehanteerd te worden. Bijvoorbeeld:
\begin{itemize}
    \item Epilepsie: vermijden van knipperende content en repetitieve patronen.
    \item Dementie: eenvoudige en duidelijke interfaces met korte instructies en visuele ondersteuning.
    \item Dyslexie: mogelijkheid tot audio-ondersteuning van content en feedback bij formulierinvoer.
    \item Aandachtstekort: overzichtelijke en korte content met directe foutmeldingen.
\end{itemize}
Door deze criteria te volgen, kan een applicatie inclusiever worden ontwikkeld en getest.

\subsubsection{Geautomatiseerde en manuele testtools}
\textcite{ZhyrovaEtAl2022} stellen dat een combinatie van geautomatiseerde en manuele tests noodzakelijk is voor een volledig beeld van toegankelijkheid. Veelgebruikte tools zijn onder andere:
\begin{itemize}
    \item \textbf{Lighthouse, AXE DevTools, WAVE:} detecteren snel contrastproblemen, ontbrekende labels en semantische fouten.
    \item \textbf{Schermlezers, toetsenbordnavigatie en vergrotingssoftware:} simuleren het gebruik door personen met visuele of motorische beperkingen.
\end{itemize}
Automatische tools bieden efficiëntie en objectieve metingen, terwijl manuele testen de daadwerkelijke gebruikservaring van personen met beperkingen evalueren.

\subsubsection{Checklist-gebaseerde evaluatie}
Naast tools is een checklist-aanpak aanbevolen, gebaseerd op WCAG. Deze checklist kan onder andere bestaan uit \autocite{ZhyrovaEtAl2022}:
\begin{itemize}
    \item \textbf{Layouttesten:} consistentie van navigatie, locatie en grootte van interface-elementen, lettertype en contrast.
    \item \textbf{Functionele testen:} toetsen van buttons, invoervelden, zoekfuncties, login-formulieren, kalenders en foutmeldingen op toegankelijkheid.
    \item \textbf{Compatibiliteitstesten:} controle van de werking met assistieve technologieën zoals schermlezers, inclusief ondersteuning voor cognitieve beperkingen.
    \item \textbf{Lokalisatietesten:} correctie van vertalingen, aanpassing van fonts en zoekfunctionaliteiten voor meertalige gebruikers.
\end{itemize}

Door deze systematische aanpak worden zowel structurele als gebruikservaringsproblemen geïdentificeerd, waardoor applicaties toegankelijker worden voor een brede doelgroep.
...
Dit onderzoek combineert theoretische inzichten over digitale toegankelijkheid met een praktische evaluatie van een bestaande mobiele applicatie. De studie start met een gerichte literatuurverkenning waarin de WCAG-richtlijnen, relevante Europese regelgeving en bestaande onderzoeksmethoden voor mobiele toegankelijkheid worden geanalyseerd. Deze literatuurstudie dient om duidelijk te bepalen welke criteria geschikt zijn om de toegankelijkheid van de applicatie objectief te meten en welke beperkingen bestaan binnen automatische testtools. Op basis daarvan wordt een set evaluatiecriteria opgesteld die consistent in het verdere onderzoek gebruikt wordt.

Vervolgens wordt de huidige Proof of Concept van de applicatie systematisch geanalyseerd via een combinatie van geautomatiseerde testen (zoals Accessibility Insights, Lighthouse en axe DevTools) en een handmatige WCAG-audit. Deze dubbelzijdige benadering maakt het mogelijk om zowel detecteerbare technische fouten als meer subtiele gebruiksproblemen in kaart te brengen. De resultaten van deze analyse vormen de basis voor het ontwikkelen van een verbeterde versie van de applicatie, waarin toegankelijkheidsaanpassingen worden geïmplementeerd en gedocumenteerd via versiebeheer.

Daarna volgt een experimentele evaluatie waarin zowel toegankelijkheid als performantie opnieuw worden getest. Hiervoor worden dezelfde toegankelijkheidstools gebruikt, aangevuld met performantiemetingen via onder andere Android Profiler en Chrome DevTools. De bedoeling is om objectief vast te stellen welke verbeteringen daadwerkelijk effect hebben gehad en of de aanpassingen een merkbare impact hebben op de prestaties van de applicatie. Alle resultaten worden vergeleken met de nulmeting om tot een onderbouwde conclusie te komen.

De methodologie verloopt volgens een gefaseerde aanpak met duidelijke deliverables: een literatuurstudie, een toegankelijkheidsrapport, een verbeterde applicatie en een experimentele vergelijking. Deze aanpak zorgt ervoor dat het onderzoek zowel technisch diepgaand als methodologisch verantwoord is binnen de context van toegepaste informatica.

%---------- Verwachte resultaten ----------------------------------------------
\section{Verwacht resultaat, conclusie}%
\label{sec:verwachte_resultaten}

Uit dit onderzoek wordt verwacht dat het systematisch toepassen van WCAG-richtlijnen een sterke basis zal vormen voor het bouwen van toegankelijkere en gebruiksvriendelijkere mobiele applicaties. Door semantische verbeteringen, duidelijke navigatiestructuren en correcte ondersteuning voor schermlezers te integreren, zal de aangepaste versie van de applicatie vermoedelijk aanzienlijk beter presteren op vlak van waarneembaarheid, bedienbaarheid en robuustheid. Tegelijkertijd wordt verwacht dat deze toegankelijkheidsaanpassingen slechts een minimale impact zullen hebben op de technische prestaties van de applicatie, aangezien de meeste optimalisaties structureel en niet computationeel zwaar zijn.

De resultaten zullen waarschijnlijk aantonen dat de kwaliteit van de toegankelijkheid in sterke mate afhangt van de manier waarop ontwerpkeuzes en ontwikkelrichtlijnen vanaf het begin worden toegepast. Naar verwachting zal de verbeterde proof-of-concept duidelijk illustreren dat een consistente toepassing van WCAG-principes leidt tot een toegankelijkere applicatie zonder noemenswaardige performantie-kosten. Dit onderzoek zal ontwikkelaars en onderwijsinstellingen daardoor concrete richtlijnen bieden voor het herkennen en aanpakken van veelvoorkomende toegankelijkheidsproblemen.

De inzichten uit deze studie kunnen studenten en ontwikkelteams helpen om mobiel leerplatformen inclusiever, betrouwbaarder en toekomstbestendiger te maken. Hierdoor kunnen hogeronderwijsinstellingen hun digitale diensten optimaliseren en beter inspelen op de noden van diverse gebruikersgroepen, waaronder studenten met een beperking.