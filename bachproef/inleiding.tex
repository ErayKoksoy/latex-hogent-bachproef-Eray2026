...
Het doel van deze bachelorproef is het realiseren van een aantoonbaar toegankelijkere en technisch geoptimaliseerde versie van de bestaande HOGENT-campusapplicatie (proof-of-concept). De huidige applicatie wordt systematisch geëvalueerd aan de hand van de Web Content Accessibility Guidelines (WCAG) \autocite{W3C_WCAG2025}, waarbij zowel geautomatiseerde testtools zoals Accessibility Insights, Lighthouse en axe DevTools \autocite{ZhyrovaEtAl2022} als handmatige evaluatiemethoden worden ingezet. Op basis van deze audit worden de meest impactvolle toegankelijkheidsproblemen op UI- en componentniveau geïdentificeerd, geïmplementeerd en gedocumenteerd.

Daarnaast wordt de impact van de toegankelijkheidsmaatregelen op de performantie van de applicatie objectief gemeten en geanalyseerd, aangezien eerder onderzoek aantoont dat toegankelijkheidsaanpassingen vaak worden uitgesteld uit vrees voor performantieverlies \autocite{Teran2021}. Het onderzoek resulteert in een verbeterde en geteste versie van de applicatie, een gedocumenteerde toegankelijkheidsanalyse en een onderbouwde set aanbevelingen voor het structureel integreren van toegankelijkheid in het ontwikkelproces. Het project wordt als succesvol beschouwd wanneer de belangrijkste WCAG-gerelateerde problemen aantoonbaar zijn verminderd, de toegankelijkheidsscores verbeteren en geen significante negatieve performantie-impact wordt vastgesteld.
